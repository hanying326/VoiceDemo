...
//     short *data = (short *)buffList->mBuffers[0].mData;
    ...
    [buffer appendBytes:buffList->mBuffers[0].mData length:buffList->mBuffers[0].mDataByteSize];
    
    [[WebSocket share] sendAudio:buffer];
    
      [[[KryptonManager share]  delegate]onAudioData:buffer];
    
    NSLog(@"audio:%d",buffer.length);
